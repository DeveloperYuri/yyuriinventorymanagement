...
@section('content')
    <main id="main" class="main">
        ...
        @if (Auth::user()->is_role == 2 || Auth::user()->is_role == 1)
            <div class="pagetitle">
                <a href="{{ route('createlocations')}}" class="btn btn-primary">Create New Locations</a>
            </div><!-- End Page Title -->
        @endif
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-hover align-middle">
                                    ...
                                    <tbody>
                                        @forelse ($getRecord as $key => $location)
                                            <tr>
                                                ...
                                                @if (Auth::user()->is_role == 2)
                                                    <td class="text-center">
                                                        <form action="{{ route('deletelocations', $location->id) }}"
                                                            method="POST">

                                                            <a href="{{ route('editlocations', $location->id) }}"
